...
public class SequencerPosPro : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (GameObject.Find("SampleSequencer_1") && GameObject.Find("CurrentPattern_Sample").GetComponent<ShowCurrentPatternScript>().currentPatternSample == 1) {
            GameObject.Find("SQPOS_SAMPLE "+ GameObject.Find("SampleSequencer_1").GetComponent<AudioHelm.SampleSequencer>().currentIndex.ToString()).GetComponent<RawImage>().color = Color.yellow;
        }
        if (GameObject.Find("SampleSequencer_2") && GameObject.Find("CurrentPattern_Sample").GetComponent<ShowCurrentPatternScript>().currentPatternSample == 2) {
            GameObject.Find("SQPOS_SAMPLE "+ GameObject.Find("SampleSequencer_2").GetComponent<AudioHelm.SampleSequencer>().currentIndex.ToString()).GetComponent<RawImage>().color = Color.yellow;
        }
        if (GameObject.Find("SampleSequencer_3") && GameObject.Find("CurrentPattern_Sample").GetComponent<ShowCurrentPatternScript>().currentPatternSample == 3) {
            GameObject.Find("SQPOS_SAMPLE "+ GameObject.Find("SampleSequencer_3").GetComponent<AudioHelm.SampleSequencer>().currentIndex.ToString()).GetComponent<RawImage>().color = Color.yellow;
        }
        if (GameObject.Find("SampleSequencer_4") && GameObject.Find("CurrentPattern_Sample").GetComponent<ShowCurrentPatternScript>().currentPatternSample == 4) {
            GameObject.Find("SQPOS_SAMPLE "+ GameObject.Find("SampleSequencer_4").GetComponent<AudioHelm.SampleSequencer>().currentIndex.ToString()).GetComponent<RawImage>().color = Color.yellow;
        }                            
    }
}
