...
public class SaveManagerPro : MonoBehaviour
{
    ...
    public IEnumerator ClearSequencer() {
        ...
        if (GameObject.Find("DrumSampler_2") && GameObject.Find("CurrentPattern_Drum").GetComponent<ShowCurrentPatternScript>().currentPatternDrum == 2 && GameObject.Find("SequencerButtonText").GetComponent<TextMeshProUGUI>().text == "DRUM") {
            ...
            for (int i = 0; i < 8; i++) { 
                for (int h = 0; h < GameObject.Find("DrumSampler_2").GetComponent<AudioHelm.SampleSequencer>().length; h++) {
                    for (int j = 0; j < 16; j++) {       
                        PlayerPrefs.SetInt("DrumSeq_2_" + (67-i) +"_"+ h +"_"+ (h+j), 0);
                    }
                    loadingText.SetActive(false);
                }                                                               
            }    
        ...
        if (GameObject.Find("DrumSampler_3") && GameObject.Find("CurrentPattern_Drum").GetComponent<ShowCurrentPatternScript>().currentPatternDrum == 3 && GameObject.Find("SequencerButtonText").GetComponent<TextMeshProUGUI>().text == "DRUM") {
            ...
            for (int i = 0; i < 8; i++) { 
                for (int h = 0; h < GameObject.Find("DrumSampler_3").GetComponent<AudioHelm.SampleSequencer>().length; h++) {
                    for (int j = 0; j < 16; j++) {       
                        PlayerPrefs.SetInt("DrumSeq_3_" + (67-i) +"_"+ h +"_"+ (h+j), 0);
                    }
                    loadingText.SetActive(false);
                }                                                               
            } 
        ...
        if (GameObject.Find("DrumSampler_4") && GameObject.Find("CurrentPattern_Drum").GetComponent<ShowCurrentPatternScript>().currentPatternDrum == 4 && GameObject.Find("SequencerButtonText").GetComponent<TextMeshProUGUI>().text == "DRUM") {
            ...
            for (int i = 0; i < 8; i++) { 
                for (int h = 0; h < GameObject.Find("DrumSampler_4").GetComponent<AudioHelm.SampleSequencer>().length; h++) {
                    for (int j = 0; j < 16; j++) {       
                        PlayerPrefs.SetInt("DrumSeq_4_" + (67-i) +"_"+ h +"_"+ (h+j), 0);
                    }
                    loadingText.SetActive(false);
                }                                                               
            }                                                        
        ...
        if (GameObject.Find("SampleSequencer_1") && GameObject.Find("CurrentPattern_Sample").GetComponent<ShowCurrentPatternScript>().currentPatternSample == 1 && GameObject.Find("SequencerButtonText").GetComponent<TextMeshProUGUI>().text == "SAMPLE") {
            GameObject.Find("SampleSequencer_1").GetComponent<AudioHelm.SampleSequencer>().Clear();         
            sampleSeqContent.GetComponent<PopulateGrid_Sample>().ReColorGridFunction();                     
            for (int i = 0; i < 16; i++) { 
                for (int h = 0; h < GameObject.Find("SampleSequencer_1").GetComponent<AudioHelm.SampleSequencer>().length; h++) {
                    for (int j = 0; j < 16; j++) {       
                        PlayerPrefs.SetInt("SampleSeq_1_" + (75-i) +"_"+ h +"_"+ (h+j), 0);
                    }
                    loadingText.SetActive(false);
                }                                                               
            } 
        ...
        if (GameObject.Find("SampleSequencer_2") && GameObject.Find("CurrentPattern_Sample").GetComponent<ShowCurrentPatternScript>().currentPatternSample == 1 && GameObject.Find("SequencerButtonText").GetComponent<TextMeshProUGUI>().text == "SAMPLE") {
            ...
            sampleSeqContent.GetComponent<PopulateGrid_Sample>().ReColorGridFunction();                     
            for (int i = 0; i < 16; i++) { 
                for (int h = 0; h < GameObject.Find("SampleSequencer_2").GetComponent<AudioHelm.SampleSequencer>().length; h++) {
                    for (int j = 0; j < 16; j++) {       
                        PlayerPrefs.SetInt("SampleSeq_2_" + (75-i) +"_"+ h +"_"+ (h+j), 0);
                    }
                    loadingText.SetActive(false);
                }                                                               
            } 
        ...
        if (GameObject.Find("SampleSequencer_3") && GameObject.Find("CurrentPattern_Sample").GetComponent<ShowCurrentPatternScript>().currentPatternSample == 1 && GameObject.Find("SequencerButtonText").GetComponent<TextMeshProUGUI>().text == "SAMPLE") {
            ...
            sampleSeqContent.GetComponent<PopulateGrid_Sample>().ReColorGridFunction();                     
            for (int i = 0; i < 16; i++) { 
                for (int h = 0; h < GameObject.Find("SampleSequencer_3").GetComponent<AudioHelm.SampleSequencer>().length; h++) {
                    for (int j = 0; j < 16; j++) {       
                        PlayerPrefs.SetInt("SampleSeq_3_" + (75-i) +"_"+ h +"_"+ (h+j), 0);
                    }
                    loadingText.SetActive(false);
                }                                                               
            } 
        ...
        if (GameObject.Find("SampleSequencer_4") && GameObject.Find("CurrentPattern_Sample").GetComponent<ShowCurrentPatternScript>().currentPatternSample == 1 && GameObject.Find("SequencerButtonText").GetComponent<TextMeshProUGUI>().text == "SAMPLE") {
            ...
            sampleSeqContent.GetComponent<PopulateGrid_Sample>().ReColorGridFunction();                     
            for (int i = 0; i < 16; i++) { 
                for (int h = 0; h < GameObject.Find("SampleSequencer_4").GetComponent<AudioHelm.SampleSequencer>().length; h++) {
                    for (int j = 0; j < 16; j++) {       
                        PlayerPrefs.SetInt("SampleSeq_4_" + (75-i) +"_"+ h +"_"+ (h+j), 0);
                    }
                    loadingText.SetActive(false);
                }                                                               
            } 
    ...
    public void LoadPatternSequencers_Drum() {
        int loop = PlayerPrefs.GetInt("SequencerCount_Drum");
        for (int i = 0; i < loop; i++) { 
            GameObject.Find("AddPattern_Drum").GetComponent<DuplicateSynthSequencerScript>().DuplicateDrumSequencer();        
        }
    ...
    public IEnumerator LoadPatternNotesIntoSeq_Drum() {
        drumSequencer.GetComponent<AudioHelm.SampleSequencer>().Clear();
        yield return new WaitForSeconds(1f);
        //Load notes into Synth Sequencer
